...
-- 正在导出表  sageassistant.log_template 的数据：~6 rows (大约)
INSERT INTO `log_template` (`id`, `template_code`, `template_group`, `template_definition`, `template_definition_en`, `template_definition_zh`, `create_at`, `create_by`, `update_at`, `update_by`) VALUES
	...
	(3, 'DOC_ACCESS_SUCCESS', 'WEBDAV', 'User {0} access {1} success.', 'User {0} access {1} success.', '用户{0}访问{1}成功。', '2024-06-24 18:03:18', NULL, '2024-06-24 18:03:18', NULL),
	(4, 'DOC_ACCESS_FAILED', 'WEBDAV', 'User {0} access {1} failed.', 'User {0} access {1} failed.', '用户{0}访问{1}失败。', '2024-06-24 18:05:30', NULL, '2024-06-24 18:05:30', NULL),
	(5, 'DOC_ACCESS_INIT_SUCCESS', 'WEBDAV', 'User {0} doc access initializing success.', 'User {0} doc access initializing success.', '用户{0}访问权限初始化成功。', '2024-06-24 18:10:24', NULL, '2024-06-24 18:10:24', NULL),
	(6, 'DOC_ACCESS_INIT_FAILED', 'WEBDAV', 'User {0} doc access initializing failed.', 'User {0} doc access initializing failed.', '用户{0}访问权限初始化失败。', '2024-06-24 18:10:45', NULL, '2024-06-24 18:10:45', NULL);
