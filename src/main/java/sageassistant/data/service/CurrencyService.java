 ...
 * @LastEditDate          : 2023-04-02 20:23:31                                                                      *
 * @FilePath              : src/main/java/sageassistant/dataSrv/service/CurrencyService.java                         *
...
import sageassistant.data.dao.CurrencyMapper;
import sageassistant.data.model.CurrencyHistory;
...
public class CurrencyService {
    ...
    private String getFromUrl(String key) {
        ...
        String responseText = HttpService
            .request("http://www.safe.gov.cn/AppStructured/hlw/ENJsonRmb.do?date=" + Date, "GET")
            .body();
