...
import sageassistant.data.dao.FinancialMapper;
import sageassistant.data.model.FinancialBalance;
import sageassistant.data.model.FinancialInvoicePay;
import sageassistant.data.model.FinancialInvoicePayPro;
...
public class FinancialService {
    ...
    public List<FinancialBalance> getAccountBalanceForAll(String Site, String Year) {
        return financialMapper.findAccountBalanceForAll(Site, Year);
    }

    public List<FinancialBalance> getAccountBalanceForAllByCat(String Site, String Year, String Cat) {
        List<FinancialBalance> list = financialMapper.findAccountBalanceForAll(Site, Year);
    ...
    public List<FinancialBalance> getAccountBalanceForAccountNO(String Site, String Year, String AccountNO) {
        String[] AccountNOs = AccountNO.split(",");
        return financialMapper.findAccountBalanceByAccountNO(Site, Year, AccountNOs);
    }
