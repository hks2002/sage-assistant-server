 ...
 * @LastEditDate          : 2025-07-15 15:50:50                                                                       *
...
public class SageLoginService {
  ...
  private static JSONObject getSageSession(
    ...
    if (json.containsKey("srvop") &&
      ...
      rtn = ResponseJson.obj(true, MsgTyp.RESULT, "Session Success");
    ...
    // without session info
      ...
      rtn = ResponseJson.obj(false, MsgTyp.ERROR, "Unknown response");
      return rtn;
    }
  }
      ...
      switch (severity) {
        ...
        case "error":
          return ResponseJson.obj(
              ...
              json.getString("$message"));
        default:
          return ResponseJson.obj(false, MsgTyp.ERROR, "Login failed");
      }
    } catch (Exception e) {
  ...
  public static JSONObject doLogout(String auth) {
    ...
    try {
      ...
      return ResponseJson.obj(false, MsgTyp.ERROR, "Logout failed");
    }
  }
