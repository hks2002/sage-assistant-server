 ...
 * @LastEditDate          : 2024-07-02 13:02:40                              *
...
public class MyWebDav extends WebdavServlet {
    ...
    protected InputStream renderHtml(HttpServletRequest request, String contextPath, WebResource resource,
        ...
        sb.append(
                "<input type=\"search\" placeholder=\"Code For Vendor or Customer\" id=\"pbCode\" style=\"width:200px; margin-left:20px;margin-bottom:5px;\">");
        sb.append("<script>\r\n");
        sb.append(
