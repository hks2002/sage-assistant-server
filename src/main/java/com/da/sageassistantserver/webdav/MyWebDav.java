 ...
 * @LastEditDate          : 2024-12-19 17:56:12                                                                       *
...
public class MyWebDav extends WebdavServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    try {
      ...
      appName = Optional.ofNullable(prop.getProperty("project.name")).orElse("");
      appVersion = Optional.ofNullable(prop.getProperty("project.version")).orElse("");
      webdavCache = Optional.ofNullable(prop.getProperty("webdav.cache")).orElse("true").equals("true");
      ...
      if (attachmentPath != "") {
        ...
        DirResourceSet dirResourceSet = new DirResourceSet(super.resources, "/", additionPath.getAbsolutePath(), "/");
  ...
  protected InputStream renderHtml(
    ...
    String bpName = Optional.ofNullable((String) session.getAttribute("bpName")).orElse("");
    ...
    for (WebResource childResource : files) {
      ...
      obj.put("url", resourcesPath + filename + (childResource.isDirectory() ? "/" : ""));
