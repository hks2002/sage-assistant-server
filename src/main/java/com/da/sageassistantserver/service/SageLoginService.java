 ...
 * @LastEditDate          : 2024-12-09 19:50:42                                                                       *
...
public class SageLoginService {
        ...
        if (json.containsKey("srvop") && json.getJSONObject("srvop").containsKey("sessionInfo")) {
            ...
            if (trans == null || trans.isBlank()) {
                ...
                try {
                    ...
                    return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, "Session and trans Failed");
                }
            }
            // with trans
            else {
                ...
                if (rtn2.getBoolean("success")) {
                    rtn = ResponseJsonHelper.rtnObj(true, MsgTyp.RESULT, "Session and trans Success");
                    rtn.put("SessionId", sessionId);
    ...
    public static JSONObject endSession(String auth, String sessionId) {
        ...
        switch (severity) {
            case "info":
                return ResponseJsonHelper.rtnObj(true, MsgTyp.INFO, json.getString("$message"));
            default:
                return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, "End session failed");
        }
    }
    ...
    public static JSONObject doLogin(String auth) {
        ...
        if (authCache.getIfPresent(auth) != null) {
            return ResponseJsonHelper.rtnObj(true, MsgTyp.RESULT, "Cache login success");
        }
        ...
        try {
            ...
            switch (severity) {
                case "info":
                    ...
                    return ResponseJsonHelper.rtnObj(true, MsgTyp.RESULT, "Login success");
                case "error":
                    return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, json.getString("$message"));
                default:
    ...
    public static JSONObject doLogout(String auth) {
        ...
        try {
            ...
            switch (severity) {
                case "success":
                    return ResponseJsonHelper.rtnObj(true, MsgTyp.RESULT, "Logout success");
                case "error":
                    return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, json.getString("$message"));
                default:
    ...
    public static JSONObject getProfile(String auth) {
        try {
            ...
            return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, "GetProfile failed");
        }
    }
    ...
    public static JSONObject getFunction(String auth) {
        try {
            ...
            return ResponseJsonHelper.rtnObj(false, MsgTyp.ERROR, "GetFunctions failed");
        }
    }
}
