 ...
 * @LastEditDate          : 2024-12-09 19:51:35                                                                       *
...
public class WorkActionService {
    ...
    public List<WorkAction> getWorkActionByProjectJsonList(String ProjectJsonList) {
        return getWorkActionByProjectJsonList(ProjectJsonList);
    }

    public List<WorkActionCnt> getWorkActionCntByProjectJsonList(String ProjectJsonList, String Site) {
        List<WorkActionCnt> list = workActionMapper.getWorkActionCntByProjectJsonList(ProjectJsonList, Site);
