 ...
 * @LastEditDate          : 2024-12-11 16:09:21                                                                      *
...
public class SupplierService {
    ...
    public List<SupplierSummaryAmount> getSupplierSummaryAmount(
        ...
        return supplierMapper.findSupplierSumAmount(Site, SupplierType, SupplierCode, DateFrom, DateTo, Interval);
    }
    ...
    public List<SupplierSummaryAmountTop> getSupplierSummaryAmountTop(
        ...
        return supplierMapper.findSupplierSumAmountTop(Site, SupplierType, DateFrom, DateTo, Limit);
    }
    ...
    public List<SupplierOTD> getSupplierOTD(
        ...
        return supplierMapper.findSupplierOTD(Site, SupplierType, SupplierCode, DateFrom, DateTo, Interval);
    }
    ...
    public List<SupplierOTDTop> getSupplierOTDTop(
        ...
        return supplierMapper.findSupplierOTDTop(Site, SupplierType, DateFrom, DateTo, Limit, Sort);
    }
    ...
    public List<SupplierQPY> getSupplierQPY(
        ...
        return supplierMapper.findSupplierQPY(Site, SupplierType, SupplierCode, DateFrom, DateTo, Interval);
    }
    ...
    public List<SupplierQPYTop> getSupplierQPYTop(
        ...
        return supplierMapper.findSupplierQPYTop(Site, SupplierType, DateFrom, DateTo, Limit, Sort);
    }
    ...
    public List<SupplierNCSummary> getSupplierNCSummary(
        ...
        return supplierMapper.findSupplierNCSummary(Site, SupplierType, SupplierCode, DateFrom, DateTo, Interval);
    }
    ...
    public Integer getSupplierOrdersCnt(
        ...
        return supplierMapper.findSupplierOrdersCnt(Site, SupplierType, SupplierCode, DateFrom, DateTo, OrderStatus);
    }
    ...
    public Integer getSupplierNCHistoryCnt(
        ...
        return supplierMapper.findSupplierNCHistoryCnt(Site, SupplierType, SupplierCode, DateFrom, DateTo);
    }
    ...
    public List<SupplierNCHistory> getSupplierNCHistory(
        ...
        return supplierMapper.findSupplierNCHistory(Site, SupplierType, SupplierCode, DateFrom, DateTo, Offset, Limit);
    }
