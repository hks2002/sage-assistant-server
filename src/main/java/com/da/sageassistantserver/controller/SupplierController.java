 ...
 * @LastEditDate          : 2024-12-11 16:09:49                                                                       *
...
public class SupplierController {
    ...
    public String getBPName(@RequestParam(value = "bpCode", required = false, defaultValue = "XXXX") String bpCode) {
    ...
    public List<SupplierOTD> getSupplierOTD(
        ...
        return (
            SupplierService.getSupplierOTD(Site, SupplierType, SupplierCode, DateFrom, DateTo + " 23:59:59", Interval)
        );
    }
    ...
    public List<SupplierQPY> getSupplierQPY(
        ...
        return (
            SupplierService.getSupplierQPY(Site, SupplierType, SupplierCode, DateFrom, DateTo + " 23:59:59", Interval)
        );
    }
    ...
    public Integer getSupplierNCHistoryCnt(
        ...
        return (
            SupplierService.getSupplierNCHistoryCnt(Site, SupplierType, SupplierCode, DateFrom, DateTo + " 23:59:59")
        );
    }
