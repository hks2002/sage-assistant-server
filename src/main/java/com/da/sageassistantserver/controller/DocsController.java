 ...
 * @LastEditDate          : 2024-12-19 18:06:48                                                                      *
...
public class DocsController {
  ...
  public JSONArray getAttachmentPathFromZHU(HttpServletRequest request, HttpServletResponse response)
    throws IOException {
  ...
  public JSONObject handleFileUpload(HttpServletRequest request, @RequestParam("file") final MultipartFile uploadFile) {
