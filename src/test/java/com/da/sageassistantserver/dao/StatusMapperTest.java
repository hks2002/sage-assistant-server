 ...
 * @LastEditDate          : 2024-10-13 16:45:51                               *
...
public class StatusMapperTest {
  ...
  void testFindTobeTrackingBOMLineBySite() {
    statusMapper.findTobeTrackingBOMLineBySite(getSite(), "NOR", "00870", "", "", "DaysLeft", "DESC", 0,
        10);
  }

  @Test
  void testFindTobeTrackingPurchaseOrderLineBySite() {
    statusMapper.findTobeTrackingPurchaseOrderLineBySite(getSite(), "NOR", "00870", "", "", "DaysLeft", "DESC", 0, 10);
  }

  @Test
  void testFindTobeTrackingNCLineBySite() {
    statusMapper.findTobeTrackingNCLineBySite(getSite(), "NOR", "00870", "", "", "DaysLeft", "DESC", 0, 10);
  }

  @Test
  void testFindTobeTrackingReceiptLineBySite() {
    statusMapper.findTobeTrackingReceiptLineBySite(getSite(), "NOR", "00870", "", "", "DaysLeft", "DESC", 0, 10);
  }

  @Test
  void testFindTobeTrackingSalesOrderLineBySite() {
    statusMapper.findTobeTrackingSalesOrderLineBySite(getSite(), "NOR", "00870", "", "", "DaysLeft", "DESC", 0, 10);
  }

  @Test
  void testFindTobeTrackingSalesOrderLineCntBySite() {
    statusMapper.findTobeTrackingSalesOrderLineCntBySite(getSite(), "NOR", "", "", "");
  }
}
