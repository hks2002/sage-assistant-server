 ...
 * @LastEditDate          : 2023-04-06 16:15:50                                                                      *
 * @FilePath              : src/test/java/sageassistant/data/service/SageServiceTest.java                            *
...
public class SageServiceTest {
    ...
    public void loadAuth() {
        auth = Utils.readFileContent("../../src/test/resources/auth.txt");
        log.info(auth);
    }
